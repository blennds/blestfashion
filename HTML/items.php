...
<div class="box" id="item8"> 
    ...
    <div class="box" id="item13"> 
        ...
        <h3>Nike</h3>
        <h1> $90.00</h1>
        <button class="btn-for-shop" onclick="addToCart(item13)">add to cart</button>
    </div>
    ...
    <div class="box" id="item14"> 
        ...
        <h3>Gucci</h3>
        <h1>$58.89</h1>
        <button class="btn-for-shop" onclick="addToCart(item14)">add to cart</button>
    </div>
    ...
    <div class="box" id="item15"> 
        ...
        <h3>Nike</h3>
        <h1>$125.99</h1>
        <button class="btn-for-shop" onclick="addToCart(item15)">add to cart</button>
    </div>
    ...
    <div class="box" id="item16"> 
        ...
        <h3>Louis Vuitton</h3>
        <h1>$63.90</h1>
        <button class="btn-for-shop" onclick="addToCart(item16)">add to cart</button>
    </div>
</div>
...
<div class="nextPages">
   ...
   <a href="items.php"><span class="active">1</span></a>
   <a href="items2.php"><span>2</span></a>
   <a href="items3.php"><span>3</span></a>
   <a href="items2.php"><span >Next</span></a>
